...
public class CalculatorView extends JFrame{
	...
	private void initComponents() {
		...
		button_divide.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		button_subtract.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		button_decimal.setFont(new Font("Tahoma", Font.PLAIN, 40));
		...
		button_Submit.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		button_clear.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		messagesFromServer.setBounds(22, 281, 263, 117);
		panel_1.add(messagesFromServer);

		button_closeBracket = new JButton(")");
		button_closeBracket.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		button_openBracket.setFont(new Font("Tahoma", Font.PLAIN, 20));
